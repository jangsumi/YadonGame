...
export const GameMenual = styled.div`
  width: 136px;
  height: 50px;
  background: #ff728a;
  border-radius: 40px;
...
export const Line21 = styled.div`
  font-family: "Inter";
  font-style: normal;
  font-weight: 500;
  font-size: 20px;
...
export const TextYadon = styled.img`
  height: 70px;
  width: 70px;
`;

export const BigYadon = styled.img`
  height: 120px;
  width: 120px;
